...
class MainActivity : AppCompatActivity() {
    ...
    private val recordeTimeTextView: CountUpTextView by lazy {
    ...
    private fun bindViews() {
        ...
        resetButton.setOnClickListener {
            ...
            recordeTimeTextView.clearCountTime()
    ...
    private fun startRecording() {
        ...
        recordeTimeTextView.startCountUp()
    ...
    private fun stopRecording() {
        ...
        recordeTimeTextView.stopCountUp()
